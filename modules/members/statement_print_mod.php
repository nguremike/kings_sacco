...
<body>
    <div class="header">
        ...
        <p>For the Year Ended 31st December <?php echo $year - 1; ?></p>
        <?php if (!empty($month)): ?>
    ...
    <div class="member-info">
        <table>
            ...
            <!-- <tr>
                <td><strong>National ID:</strong> <?php //echo $member['national_id']; 
                                                    ?></td>
                <td><strong>Phone:</strong> <?php //echo $member['phone']; 
                                            ?></td>
            </tr> -->
            <tr>
                <!-- <td><strong>Date Joined:</strong> <?php //echo formatDatePrint($member['date_joined']); 
                                                        ?></td> -->
                <td colspan="2"><strong>As at:</strong> <?php echo "31st December 2025"; ?></td>
            </tr>
        </table>
    </div>
        ...
        <table>
            ...
            <tbody>
                ...
                <?php if ($deposits->num_rows == 0): ?>
                    <tr>
                        <td colspan="6" class="text-center"> <?php echo "-"; ?></td>
                    </tr>
                <?php endif; ?>
            </tbody>
            <tfoot>
